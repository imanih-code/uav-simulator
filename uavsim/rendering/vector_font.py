...
GLYPHS: Dict[str, List[Segment]] = {
    ...
    "R": [_TOP, _TOP_LEFT, _TOP_RIGHT, (_ML, _MM), (_MM, _MR), _BOT_LEFT, (_MM, _BR)],
    "S": [_TOP, _TOP_LEFT, _MID, _BOT_RIGHT, _BOTTOM],
    "T": [(_TL, _TM), (_TM, _TR), (_TM, _BM)],
    "W": [_TOP_LEFT, _BOT_LEFT, _TOP_RIGHT, _BOT_RIGHT, (_BL, _MM), (_BR, _MM)],
    "X": [(_TL, _MM), (_MM, _BR), (_TR, _MM), (_MM, _BL)],
    "Y": [(_TL, _MM), (_TR, _MM), (_MM, _BM)],
    "Z": [_TOP, (_TR, _BL), _BOTTOM],
    ">": [((0.0, 0.0), (0.7, 0.5)), ((0.7, 0.5), (0.0, 1.0))],
    ".": [((0.4, 0.0), (0.5, 0.1))],
    "-": [_MID],
    ...
    "F": [_TOP, _TOP_LEFT, _MID, _BOT_LEFT],
    "Q": [_TOP, _TOP_LEFT, _TOP_RIGHT, _BOT_LEFT, _BOT_RIGHT, _BOTTOM, ((0.7, 0.15), (1.0, 0.0))],
